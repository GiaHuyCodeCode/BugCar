...
export const StoreSwitcher = ({items}: StoreSwitcherProps)=>{
    ...
    return(
      ...
      <PopoverContent className="w-[200px] p-0">
        <Command>
          <div className="w-full px-2 py-1 flex items-center  rounded-md ">
          <StoreIcon className="mr-2 h-4 w-4 min-w-4 "/>
          <input type="text" placeholder="Search Store.." onChange={handleSearchTerm} className="flex-1 w-full outlline-none "/>
          </div>
          <CommandList>
